...
export const LoginModal = ({ isOpen, onClose, onLoginSuccess }: LoginModalProps) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-end justify-center p-2 sm:p-4 md:items-center md:p-6">
        <motion.div
          ref={modalRef}
          ...
          className="relative w-full max-w-[95%] sm:max-w-md md:max-w-lg lg:max-w-xl"
        >
          {/* Main Card - Glass Morphism */}
          <div className="relative bg-gradient-to-br from-white/[0.08] to-white/[0.04] rounded-2xl sm:rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden border border-white/[0.15] backdrop-blur-[20px]">
            ...
            {/* Mobile handle - Hidden on larger screens */}
            <div className="sm:hidden pt-3 pb-1 flex justify-center relative z-10">
              <div className="w-14 h-1.5 bg-gradient-to-r from-white/[0.3] via-white/[0.5] to-white/[0.3] rounded-full shadow-lg shadow-white/[0.1]"></div>
            </div>

            {/* Header - Responsive padding */}
            <div className="relative px-4 py-3 sm:px-5 sm:py-4 md:px-6 md:py-5 border-b border-white/[0.15] backdrop-blur-sm">
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="p-1.5 sm:p-2 rounded-full bg-white/[0.1] border border-white/[0.2] backdrop-blur-sm">
                  ...
                  <div>
                    ...
                    <p className="text-white/[0.6] text-xs sm:text-sm">
                ...
                <Button
                  ...
                  size="icon"
                  onClick={onClose}
                  className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 rounded-full hover:bg-white/[0.1] backdrop-blur-sm border border-white/[0.15]"
                >
                  <X className="h-4 w-4 sm:h-5 sm:w-5 text-white/[0.8] hover:text-white" />
                </Button>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-5 md:p-6">
              ...
              <div className="mb-4 sm:mb-5 md:mb-6">
                <div className="relative bg-white/[0.05] rounded-lg sm:rounded-xl p-0.5 sm:p-1 flex border border-white/[0.1] backdrop-blur-sm">
                  <div
                    className="absolute top-0.5 sm:top-1 left-0.5 sm:left-1 w-1/2 h-[calc(100%-0.25rem)] sm:h-[calc(100%-0.5rem)] bg-white/[0.15] rounded-md sm:rounded-lg shadow-sm transition-all duration-500 backdrop-blur-sm"
                    style={{ transform: isLogin ? 'translateX(0)' : 'translateX(100%)' }}
                  ></div>
                  <button
                    onClick={() => setIsLogin(true)}
                    className={cn(
                      "relative z-10 flex-1 py-1.5 sm:py-2 text-center rounded-md sm:rounded-lg transition-all duration-300 text-xs sm:text-sm",
              ...
              <AnimatePresence mode="wait">
                {isLogin ? (
                  ...
                  >
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <User className="h-3 w-3 sm:h-4 sm:w-4 text-emerald-300" />
                        <label className="text-xs sm:text-sm font-medium text-white">Username</label>
                      </div>
                      <input
                        {...loginForm.register("username", { required: "Username is required" })}
                        type="text"
                        className="w-full p-2 sm:p-2.5 md:p-3 border border-white/[0.15] rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500/40 bg-white/[0.05] text-white text-xs sm:text-sm placeholder-white/[0.4] transition-all backdrop-blur-sm"
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <Lock className="h-3 w-3 sm:h-4 sm:w-4 text-emerald-300" />
                        <label className="text-xs sm:text-sm font-medium text-white">Password</label>
                      </div>
                      <input
                    ...
                    <div className="p-2 sm:p-2.5 md:p-3 bg-white/[0.05] rounded-lg border border-white/[0.1] backdrop-blur-sm">
                      <div className="flex items-start gap-2">
                        <Shield className="h-3 w-3 sm:h-4 sm:w-4 text-emerald-300 mt-0.5 flex-shrink-0" />
                    ...
                    >
                      <Button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white font-semibold py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl shadow-sm hover:shadow-md transition-all duration-300 text-xs sm:text-sm backdrop-blur-sm"
                      >
                        <div className="flex items-center justify-center gap-1 sm:gap-2">
                          {isLoading ? (
                            <motion.div
                  ...
                  >
                    ...
                    <div className="space-y-1 sm:space-y-2">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <Phone className="h-3 w-3 sm:h-4 sm:w-4 text-emerald-300" />
                        <label className="text-xs sm:text-sm font-medium text-white">Phone Number</label>
                      </div>
                      <input
                    ...
                    {/* Registration Benefits - Responsive */}
                    <div className="p-2 sm:p-2.5 md:p-3 bg-white/[0.05] rounded-lg border border-white/[0.1] backdrop-blur-sm">
                      <div className="flex items-start gap-2">
                        <Sparkles className="h-3 w-3 sm:h-4 sm:w-4 text-emerald-300 mt-0.5 flex-shrink-0" />
                        <div>
              ...
              >
                <p className="text-xs sm:text-sm text-white/[0.6]">
          ...
          {/* Mobile close hint - Hidden on larger screens */}
